...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-header-1 text-white hover:opacity-90 focus:ring-header-1',
    secondary: 'bg-global-15 text-global-2 border border-header-1 hover:bg-global-10 focus:ring-header-1',
